    ...
    public function run()
    {
        $templates = [
            [
                ...
                'header_logo_image' => null,
                'header_details' => "Unit 202 Campos Rueda Bldg., Urban Avenue, Brgy. Pio Del Pilar, Makati City, 1230\n(02) 8646-6136",
        ...
        foreach ($templates as $t) {
            DB::table('warning_letter_templates')->updateOrInsert(['slug' => $t['slug']], $t);
        }
    }
}
