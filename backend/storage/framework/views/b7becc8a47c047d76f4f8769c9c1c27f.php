...
<?php if($showFirst): ?>
    <div class="doc">
        <div class="header">
            <?php if(!empty($template['evaluationLogoImage'])): ?>
                <div class="logo-wrap">
                    <img class="logo-image" src="<?php echo e($template['evaluationLogoImage']); ?>" alt="Office Logo">
                </div>
            <?php endif; ?>
            <?php if(!empty($template['headerDetails'])): ?>
                <div class="address"><?php echo e($template['headerDetails']); ?></div>
            <?php endif; ?>
            <div class="company"><?php echo e($template['companyName'] ?? 'Company Name'); ?></div>
            <div class="title"><?php echo e($template['title'] ?? 'PERFORMANCE APPRAISAL'); ?></div>
        </div>

        <div class="meta">
            <div class="meta-row">
                <span class="meta-label"><?php echo e($template['metaNameLabel'] ?? 'NAME'); ?></span>
                <span class="meta-value-line"><span class="meta-value"><?php echo e($fullName); ?></span></span>
            </div>
            <div class="meta-row">
                <span class="meta-label"><?php echo e($template['metaDepartmentLabel'] ?? 'DEPARTMENT/JOB TITLE'); ?></span>
                <span class="meta-value-line"><span class="meta-value"><?php echo e($deptTitle); ?></span></span>
            </div>
            <div class="meta-row">
                <span class="meta-label"><?php echo e($template['metaRatingPeriodLabel'] ?? 'RATING PERIOD'); ?></span>
                <span class="meta-value-line">
                    <span class="meta-value"><?php echo e($firstEvalDate); ?></span>
        ...
        <table class="criteria">
            <thead>
                <tr>
                    <th style="width:70%;"><?php echo e($template['criteriaHeader'] ?? 'CRITERIA'); ?></th>
                    <th style="width:30%;"><?php echo e($template['ratingHeader'] ?? 'RATING'); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php $__currentLoopData = $criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criterion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <div class="criterion-title"><?php echo e($criterion['label']); ?></div>
                            <div class="criterion-desc"><?php echo e($criterion['desc']); ?></div>
                        </td>
                        <td class="rating-cell">
                            <div class="rating-line"><?php echo e($firstBreakdown[$criterion['id']] ?? ''); ?></div>
                        </td>
                    </tr>
        ...
        <table class="total-row">
            <tr>
                ...
                <td class="total-score-cell"><span class="total-value-line"><?php echo e($evaluation->score_1 ?? ''); ?></span></td>
            </tr>
        </table>

        <div class="agreement">
            <?php echo e($template['agreementText'] ?? 'The above appraisal was discussed with me by my superior and I'); ?>

            <span class="<?php echo e(($evaluation->agreement_1 ?? '') === 'agree' ? 'box checked' : 'box'); ?>"></span> agree
            <span class="<?php echo e(($evaluation->agreement_1 ?? '') === 'disagree' ? 'box checked' : 'box'); ?>"></span> disagree on the following items:
        </div>
        ...
        <div class="subhead"><?php echo e($template['ratingScaleTitle'] ?? 'EMPLOYEE SHALL BE RATED AS FOLLOWS:'); ?></div>
        <div class="list">
            <?php $__currentLoopData = $ratingScaleLines ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div><?php echo e($line); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <div class="subhead" style="margin-top:6px;"><?php echo e($template['interpretationTitle'] ?? 'INTERPRETATION OF TOTAL RATING SCORE:'); ?></div>
        <div class="list" style="margin-left:0;">
            <?php $__currentLoopData = $interpretationLines ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div><?php echo e($line); ?></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <div class="recommend">
            <?php echo e($template['recommendationLabel'] ?? 'RECOMMENDATION: REGULAR EMPLOYMENT'); ?>

            <span class="<?php echo e($firstResult === 'Passed' ? 'box checked' : 'box'); ?>"></span> YES
            <span class="<?php echo e($firstResult === 'Failed' ? 'box checked' : 'box'); ?>"></span> NO
        </div>

        <div class="bottom-block">
            <div class="comments-title"><?php echo e($template['remarksLabel'] ?? 'COMMENTS / REMARKS:'); ?></div>
            <div class="comments-line"><?php echo e(($firstResult ?? 'N/A') . ': ' . ($evaluation->comment_1 ?? '-')); ?></div>

            <table class="manager">
                <tr>
                    <td class="manager-field"><span class="manager-label"><?php echo e($template['ratedByLabel'] ?? 'Rated by:'); ?></span><span class="manager-line"><span class="manager-name"><?php echo e($evaluation->rated_by ? substr($evaluation->rated_by, 0, 25) : ''); ?></span></span></td>
                    <td class="manager-field"><span class="manager-date-label">Date:</span><span class="manager-line manager-date-line"></span></td>
                </tr>
                <tr>
                    <td class="manager-field"><span class="manager-label"><?php echo e($template['reviewedByLabel'] ?? 'Reviewed by:'); ?></span><span class="manager-line"><span class="manager-name"><?php echo e($evaluation->reviewed_by ? substr($evaluation->reviewed_by, 0, 25) : ''); ?></span></span></td>
                    <td class="manager-field"><span class="manager-date-label">Date:</span><span class="manager-line manager-date-line"></span></td>
                </tr>
                <tr>
                    <td class="manager-field"><span class="manager-label"><?php echo e($template['approvedByLabel'] ?? 'Approved by:'); ?></span><span class="manager-line"><span class="manager-name"><?php echo e($evaluation->approved_by ? substr($evaluation->approved_by, 0, 25) : ''); ?></span></span></td>
                    <td class="manager-field"><span class="manager-date-label">Date:</span><span class="manager-line manager-date-line"></span></td>
                </tr>
            </table>
        </div>
...
<?php if($showSecond): ?>
    <div class="doc <?php echo e($showFirst ? 'page-break' : ''); ?>">
        <div class="header">
            <?php if(!empty($template['evaluationLogoImage'])): ?>
                <div class="logo-wrap">
                    <img class="logo-image" src="<?php echo e($template['evaluationLogoImage']); ?>" alt="Office Logo">
        ...
        <div class="meta">
            ...
            <div class="meta-row">
                <span class="meta-label"><?php echo e($template['metaRatingPeriodLabel'] ?? 'RATING PERIOD'); ?></span>
                <span class="meta-value-line">
                    <span class="meta-value"><?php echo e($secondEvalDate); ?></span>
            ...
            <tbody>
                <?php $__currentLoopData = $criteria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criterion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="rating-cell">
                            <div class="rating-line"><?php echo e($secondBreakdown[$criterion['id']] ?? ''); ?></div>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        ...
        <table class="total-row">
            <tr>
                <td class="total-label-cell">TOTAL SCORE</td>
                <td class="total-score-cell"><span class="total-value-line"><?php echo e($evaluation->score_2 ?? ''); ?></span></td>
            </tr>
        </table>
        ...
        <div class="agreement">
            ...
            <span class="<?php echo e(($evaluation->agreement_2 ?? '') === 'agree' ? 'box checked' : 'box'); ?>"></span> agree
            <span class="<?php echo e(($evaluation->agreement_2 ?? '') === 'disagree' ? 'box checked' : 'box'); ?>"></span> disagree on the following items:
        </div>
        ...
        <div class="recommend">
            ...
            <span class="<?php echo e($secondResult === 'Passed' ? 'box checked' : 'box'); ?>"></span> YES
            <span class="<?php echo e($secondResult === 'Failed' ? 'box checked' : 'box'); ?>"></span> NO
        </div>

        <div class="bottom-block">
            <div class="comments-title"><?php echo e($template['remarksLabel'] ?? 'COMMENTS / REMARKS:'); ?></div>
            <div class="comments-line"><?php echo e(($secondResult ?? 'N/A') . ': ' . ($evaluation->comment_2 ?? '-')); ?></div>

            <table class="manager">
                <tr>
                    <td class="manager-field"><span class="manager-label"><?php echo e($template['ratedByLabel'] ?? 'Rated by:'); ?></span><span class="manager-line"><span class="manager-name"><?php echo e($evaluation->rated_by_2 ? substr($evaluation->rated_by_2, 0, 25) : ''); ?></span></span></td>
                    <td class="manager-field"><span class="manager-date-label">Date:</span><span class="manager-line manager-date-line"></span></td>
                </tr>
                <tr>
                    <td class="manager-field"><span class="manager-label"><?php echo e($template['reviewedByLabel'] ?? 'Reviewed by:'); ?></span><span class="manager-line"><span class="manager-name"><?php echo e($evaluation->reviewed_by_2 ? substr($evaluation->reviewed_by_2, 0, 25) : ''); ?></span></span></td>
                    <td class="manager-field"><span class="manager-date-label">Date:</span><span class="manager-line manager-date-line"></span></td>
                </tr>
                <tr>
                    <td class="manager-field"><span class="manager-label"><?php echo e($template['approvedByLabel'] ?? 'Approved by:'); ?></span><span class="manager-line"><span class="manager-name"><?php echo e($evaluation->approved_by_2 ? substr($evaluation->approved_by_2, 0, 25) : ''); ?></span></span></td>
                    <td class="manager-field"><span class="manager-date-label">Date:</span><span class="manager-line manager-date-line"></span></td>
                </tr>
            </table>
        </div>
...
<?php /**PATH C:\MY PROJECTS\ABIC-ACCOUNTING-FRONTEND\backend\resources\views/pdf/evaluation.blade.php ENDPATH**/ ?>