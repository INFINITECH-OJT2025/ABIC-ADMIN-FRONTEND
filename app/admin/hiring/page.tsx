...
function buildOnboardHref(row: JobOfferRow): string {
  ...
  return `/admin/employee/onboard?${params.toString()}`;
}
          ...
          <div className="w-full px-4 md:px-8 py-3">
            <div className="flex flex-wrap items-center gap-4 lg:gap-8">
              <div className="flex items-center bg-white/10 p-1 rounded-lg backdrop-blur-md border border-white/10">
                ...
                <Link href="/admin/hiring/applicants">
            ...
            <Table className="border-collapse w-full text-[12px] table-fixed">
              ...
              <TableBody className="divide-y divide-stone-100">
                {filteredSummaryRows.map((row) => {
                  const editable =
                    !isViewOnly && (row.isNew || editingSummaryId === row.id);
            ...
            <Table className="border-collapse w-full text-[12px] table-fixed">
              ...
              <TableBody className="divide-y divide-stone-100">
                {filteredJobOffers.map((row) => {
                  const editable =
                    !isViewOnly && (row.isNew || editingJobOfferId === row.id);
